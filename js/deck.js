...
(function () {
  ...
  (function setupFgcModal() {
    ...
    const DATA = {
      'event-night': {
        ...
        title: 'Event Night',
        desc: 'CarShield at the centre of fight night — money-can\'t-buy fan experiences and guaranteed PFL star power that put the brand face-to-face with fans at every event.',
        videos: [
          {
            src: 'assets/video/event/meet_greet', label: 'Fighter Meet & Greet',
            vdesc: 'Money-can\'t-buy access for fans and competition winners — signings, photos and face time with PFL stars, delivered as CarShield-branded experiences.'
          },
          {
      ...
      'fight-highlights': {
        ...
        clickToPlay: true,
        desc: 'Automated, broadcast-quality highlight packages cut within minutes of every PFL fight — delivered to CarShield to repurpose across owned channels, driving engagement and excitement around every event. All powered by WSC Sports.',
        videos: [
          {
  ...
  (function setupWatchBetPlayer() {
    const frame = document.querySelector('[data-slide="12"] .wb-frame');
    if (!frame) return;
